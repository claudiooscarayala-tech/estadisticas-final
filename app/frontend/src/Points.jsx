  ...
  return (
    <div className="fade-in">
      <header className="page-header">
        <h1 className="page-title">{user?.role === 'producer' ? "Mis Puntos" : "Puntos Ganados"}</h1>
        <p className="page-subtitle">{user?.role === 'producer' ? "Tu estado de cuenta de recompensas" : "Sistema de recompensas para productores (1 punto = 0.01% recaudado)"}</p>
      </header>
      ...
      <div className="glass-card fade-in delay-3" style={{ padding: "1.5rem", marginBottom: "2rem" }}>
        <h3 style={{ marginBottom: "1rem", color: "var(--text-main)", fontSize: "1.1rem" }}>{user?.role === 'producer' ? "Mi Estado de Cuenta" : "Estado de Cuenta por Productor"}</h3>
